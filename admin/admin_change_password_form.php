...
<head>
    ...
    <title>LRA - ADMIN: <?php echo strtoupper($_SESSION['username']); ?> CHANGE PASSWORD FORM</title>
</head>
<body>
    ...
    if(isset($_POST['change_password_btn']))
    {
        ...
        $query = mysqli_query($conn, "SELECT user_password FROM `admin` WHERE username = '$username'");
        ...
        if($old_password == $current_password)
        {
            if(!$uppercase || !$lowercase || !$number)
            {
                ...
                $query = mysqli_query($conn, "UPDATE `admin` SET user_password = '$new_password' WHERE username = '$username'");
                ?>
                <script>
