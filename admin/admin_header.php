<header class="header" id="header">
    <div class="header_wrapper">
        <div class="header_logo_wrapper">
            <a href="./admin_dashboard.php"><img src="../assets/images/Land_Registration_Authority_Logo.png" alt="Land_Registration_Authority_Logo" class="header_logo"></a>
        ...
        <div class="gear_wrapper">
            ...
            <div class="log_out_wrapper">
                <a href="./admin_change_password_form.php" class="change_password_link">CHANGE PASSWORD</a>
