...
<head>
    ...
    <title>LRA - ADMIN: <?php echo strtoupper($_SESSION['username']); ?> UPDATE DATA FORM</title>
</head>
<body>
    ...
    if(isset($_POST['update_data_btn']))
    {
        ...
        ) 
        {
            ...
            ?>
            <script>
               location.href = "admin_manage_pending_data_table.php";
            </script>
            <?php
        }
        else if
        ...
        ) 
        {
            ...
            ?>
            <script>
               location.href = "./admin_manage_decided_data_table.php";
            </script>
            <?php
        }
        else {
