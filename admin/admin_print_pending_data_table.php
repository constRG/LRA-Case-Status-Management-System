...
<head>
    ...
    <title>LRA - ADMIN: <?php echo strtoupper($_SESSION['username']); ?> PRINT PENDING DATA TABLE</title>
</head>
<body onLoad="print()">
    ...
    <main class="main" id="main">
        ...
        <div class="data_table_wrapper">
            <div class="data_table_actions">
                <a href="./admin_manage_pending_data_table.php" class="cancel_print_link">CANCEL</a>
            </div>
                ...
                <table class="data_table" id="data_table">
                    ...
                    <tbody class="data_table_body">
                        <?php 
                            $query = mysqli_query($conn, "SELECT * FROM `lra_data_tb` WHERE status = 'PENDING' ORDER BY id DESC");
