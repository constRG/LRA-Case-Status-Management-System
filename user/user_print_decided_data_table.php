...
<head>
    ...
    <title>LRA - USER: <?php echo strtoupper($_SESSION['username']); ?> PRINT DECIDED DATA TABLE</title>
</head>
<body onLoad="print()">
    ...
    <main class="main" id="main">
        ...
        <div class="data_table_wrapper">
            <div class="data_table_actions">
                <a href="./user_manage_decided_data_table.php" class="cancel_print_link">CANCEL</a>
            </div>
