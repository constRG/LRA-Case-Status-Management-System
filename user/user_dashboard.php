...
<head>
    ...
    <title>LRA - USER: <?php echo strtoupper($_SESSION['username']); ?> DASHBOARD</title>
</head>
<body>
    ...
    <div class="main_wrapper">
        ...
        <div class="dashboard">
            <div class="dashboard_wrapper ">
                ...
                <a href="./user_judicial_regions_total_number_of_cases.php">
                ...
                <div class="dashboard_menu user_dashboard_menu">

                    <div class="dashboard_menu_item dashboard_menu_item_manage_data_table user_dashboard_menu_item_manage_data_table">
                        <div class="dashboard_menu_item_content">
                            <a href="user_manage_all_data_table.php"><h1 class="dashboard_menu_item_content_title dashboard_menu_item_manage_all_data_table_title">MANAGE ALL DATA</h1></a>
                        </div>
                    </div>

                    <div class="dashboard_menu_item dashboard_menu_item_pending">
                        <div class="dashboard_menu_item_content">
                            <a href="./user_manage_pending_data_table.php"><span class="dashboard_menu_item_content_title">NO. OF PENDING</span></a>
                            <?php
                    ...
                    <div class="dashboard_menu_item dashboard_menu_item_decided">
                        <div class="dashboard_menu_item_content">
                            <a href="./user_manage_decided_data_table.php"><span class="dashboard_menu_item_content_title">NO. OF DECIDED</span></a>
                            <?php
                    ...
                    <div class="dashboard_menu_item dashboard_menu_item_total_cases">
                        <div class="dashboard_menu_item_content">
                        <a href="./user_manage_all_data_table.php"><span class="dashboard_menu_item_content_title">TOTAL CASES</span></a>
                            <?php 
