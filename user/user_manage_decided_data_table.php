...
<head>
    ...
    <title>LRA - USER: <?php echo strtoupper($_SESSION['username']); ?> MANAGE DECIDED DATA TABLE</title>
</head>
<body>
    ...
    <main class="main" id="main">
        <div class="main_wrapper">
            <ul class="main_pages">
                ...
                <li class="main_pages_item"><a href="" class="main_pages_item_link active">| MANAGE DECIDED DATA</a></li>
            </ul>
            ...
            <div class="data_table_wrapper">
                ...
                <div class="data_table_actions">
                    ...
                    <div class="data_table_actions_btn">
                        <a href="./user_add_data_form.php" class="add_data_link">ADD DATA</a>
                        <form action="../export_decided_data_table_to_excel.php" method="POST">
                            <button type="submit" name="export_to_excel_btn" class="export_to_excel_btn">EXPORT TO EXCEL</button>
                        </form>
                        <a href="./user_print_decided_data_table.php" class="print_btn">PRINT</a>
                    </div>
                </div>    
                        ...
                        <tbody class="data_table_body">
                            <?php 
                                ...
                                if(isset($_POST['search_data_btn']))
                                {
                                    ...
                                    $query = mysqli_query($conn, "SELECT * FROM `lra_data_tb` WHERE status = 'DECIDED' AND CONCAT(case_number, subject_matter) LIKE '%$search_data%'");
                                ...
                                $query = mysqli_query($conn, "SELECT * FROM `lra_data_tb` WHERE status = 'DECIDED' ORDER BY id DESC LIMIT $start_from, $limit");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td  class="data_table_td_actions">
                                                <a href="./user_update_data_form.php?id=<?php echo $row["id"] ?>" class="update_data_link">UPDATE</a>
                                            </td>
                                        </tr>
                                    <?php
                                }               
                ...
                <?php  
                    $query = mysqli_query($conn, "SELECT COUNT(*) as case_number FROM `lra_data_tb` WHERE status = 'DECIDED'"); 
                        ...
                        <ul class="pagination">
                            <?php
                                for ($i=1; $i <= $total_pages; $i++) {
                                    ?>    
                                    <li class="page_item"><a class="page_link" href="./user_manage_decided_data_table.php?page=<?php echo $i ?>"><?php echo $i ?></a></li> 	
                                    <?php
                                }
                            ?>
                        </ul>
