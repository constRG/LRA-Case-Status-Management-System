...
<head>
    ...
    <title>LRA - USER: <?php echo strtoupper($_SESSION['username']); ?> MANAGE PENDING DATA TABLE</title>
</head>
<body>
    ...
    <main class="main" id="main">
        <div class="main_wrapper">
            <ul class="main_pages">
                ...
                <li class="main_pages_item"><a href="" class="main_pages_item_link active">| MANAGE PENDING DATA</a></li>
            ...
            <div class="data_table_wrapper">
                ...
                <div class="data_table_actions">
                    ...
                    <div class="data_table_actions_btn">
                        ...
                        <a href="./user_print_pending_data_table.php" class="print_btn">PRINT</a>
                    </div>
                </div>    
                        ...
                        <ul class="pagination">
                            <?php
                                for ($i=1; $i <= $total_pages; $i++) {
                                    ?>    
                                    <li class="page_item"><a class="page_link" href="./user_manage_pending_data_table.php?page=<?php echo $i ?>"><?php echo $i ?></a></li> 	
                                    <?php
                                }
                            ?>
                        </ul>
