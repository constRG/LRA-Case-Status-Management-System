...
<head>
    ...
    <title>LRA - VIEWER: <?php echo strtoupper($_SESSION['username']); ?> VIEW DECIDED DATA TABLE</title>
</head>
<body>
    ...
    <main class="main" id="main">
        <div class="main_wrapper">
            ...
            <ul class="main_pages">
                ...
                <li class="main_pages_item"><a href="" class="main_pages_item_link active">| VIEWER VIEW DECIDED DATA</a></li>
            </ul>
            ...
            <div class="data_table_wrapper">
                <div class="data_table_actions">
                    ...
                    <div class="data_table_actions_btn">
                        ...
                        <a href="./viewer_print_decided_data_table.php" class="print_btn">PRINT</a>
                    </div>
                </div>    
                        ...
                        <ul class="pagination">
                            <?php
                                for ($i=1; $i <= $total_pages; $i++) {
                                    ?>    
                                    <li class="page_item"><a class="page_link" href="./viewer_view_decided_data_table.php?page=<?php echo $i ?>"><?php echo $i ?></a></li> 	
                                    <?php
                                }
                            ?>
                        </ul>
