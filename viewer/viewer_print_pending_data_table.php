...
<head>
    ...
    <title>LRA - VIEWER: <?php echo strtoupper($_SESSION['username']); ?> PRINT PENDING DATA TABLE</title>
</head>
<body onLoad="print()">
    ...
    <main class="main" id="main">
        ...
        <div class="data_table_wrapper">
            <div class="data_table_actions">
                <a href="./viewer_view_pending_data_table.php" class="cancel_print_link">CANCEL</a>
            </div>
